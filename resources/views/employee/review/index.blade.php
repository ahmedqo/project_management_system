...
@section('content')
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        <div class="p-4 flex items-center justify-between gap-4">
            ...
            <div class="w-max flex items-center gap-2">
                ...
                <a href="{{ route('views.reviews.create', ['employee' => $employee->id]) }}"
    ...
    <div class="w-full bg-white p-4 rounded-lg ">
        <table x-table x-hide="2" x-name="{{ $employee->firstName }}-{{ $employee->lastName }}-reviews">
            <thead>
                <tr>
                    <td>
                        date
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="w-full h-full flex items-center justify-center gap-2">
                                <a href="{{ route('views.employees.reviews.summary', $row->id) }}"
                                ...
                                <a href="{{ route('views.reviews.edit', $row->id) }}"
                                ...
                                <a href="{{ route('actions.reviews.destroy', $row->id) }}"
