...
@section('content')
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        <div class="p-4 flex items-center justify-between gap-4">
            ...
            <div class="w-max flex items-center gap-2">
                ...
                <a href="{{ route('views.projects.create', ['employee' => $employee->id]) }}"
    ...
    <div class="w-full bg-white p-4 rounded-lg ">
        <table x-table x-hide="5" x-name="employee #{{ $employee->id }} leaves">
            <thead>
                <tr>
                    <td>
    ...
    <div class="rounded-md overflow-hidden  border border-gray-300">
        <table class="w-full text-md text-gray-900">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="px-4 py-2 text-center uppercase">no records found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
