    ...
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        <div class="p-4 flex items-center justify-between gap-4">
            ...
            <div class="w-max flex items-center gap-2">
                ...
                <a href="{{ route('views.employees.edit', $data->id) }}"
        ...
        @include('employee.navigation', ['id' => $data->id])
    </div>
        ...
        <div class="w-full flex flex-col gap-4">
            ...
            <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="w-full">
                    ...
                    <div x-ucfirst
                        class="appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md block w-full p-2 focus:outline-1 outline-primary">
                        {{ $data->insurance()->first()->name }} ({{ $data->insurance()->first()->company }})</div>
                </div>
                <div class="w-full">
                    <label x-ucfirst class="block text-sm font-black text-gray-900 mb-1">Status</label>
                    <div x-ucfirst
                        class="appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md block w-full p-2 focus:outline-1 outline-primary">
                        {{ $data->status ? 'Active' : 'Inactive' }}</div>
                </div>
            </div>
        </div>
    </div>
...
@section('print')
    ...
    <div class="flex flex-col gap-4">
        <div class="w-full flex flex-wrap gap-4">
            <div
                class="bg-gray-50 border border-gray-300 rounded-md aspect-square h-[275px] flex items-center justify-center overflow-hidden">
                <img class="max-w-full max-h-full block"
                    src="{{ $data->photo ? asset('storage/profile/' . $data->photo) : 'data:image/svg+xml;base64,' }}" />
            </div>
