...
@section('content')
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        <div class="p-4 flex items-center justify-between gap-4">
            ...
            <div class="w-max flex items-center gap-2">
                ...
                <a href="{{ route('views.accounts.create') }}"
    ...
    <div class="w-full bg-white p-4 rounded-lg ">
        <table x-table x-hide="5" x-name="accounts">
            <thead>
                <tr>
                    <td>
                        bank
            ...
            <tbody>
                @foreach ($data as $row)
                    <tr>
                        ...
                        <td>
                            @include('tool-banner', [
                                'edit' => route('views.accounts.edit', $row->id),
                                'delete' => route('actions.accounts.destroy', $row->id),
                            ])
                        </td>
                    </tr>
                @endforeach
            ...
            <tbody>
                @forelse($data as $row)
                    <tr>
                        ...
                        <td class="px-4 py-2">
                            {{ Carbon::parse($row->updated_at)->toDateString() }}
                        </td>
                    </tr>
                @empty
                    <tr>
