    ...
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        <div class="p-4 flex items-center justify-between gap-4">
            ...
            <div class="w-max flex items-center gap-2">
                ...
                <a href="{{ route('views.policies.edit', $data->id) }}"
...
@section('print')
    <h1 class="text-gray-900 font-black text-2xl text-center mb-16 flex flex-col gap-1">
        Policy #{{ $data->id }} Summary
