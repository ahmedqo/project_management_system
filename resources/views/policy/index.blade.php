...
@section('content')
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        <div class="p-4 flex items-center justify-between gap-4">
            ...
            <div class="w-max flex items-center gap-2">
                ...
                <a href="{{ route('views.policies.create') }}"
    ...
    <div class="w-full bg-white p-4 rounded-lg ">
        <table x-table x-hide="2" x-name="policies">
            <thead>
                <tr>
                    <td>
                        name
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="w-full h-full flex items-center justify-center gap-2">
                                <a href="{{ route('views.policies.summary', $row->id) }}"
                                ...
                                <a href="{{ route('views.policies.edit', $row->id) }}"
                                ...
                                <a href="{{ route('actions.policies.destroy', $row->id) }}"
...
@section('print')
    <h1 class="text-gray-900 font-black text-2xl text-center mb-16">Policies List</h1>
