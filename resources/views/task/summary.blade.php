    ...
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        <div class="p-4 flex items-center justify-between gap-4">
            ...
            <div class="w-max flex items-center gap-2">
                ...
                <a href="{{ route('views.tasks.edit', $data->id) }}"
...
@section('print')
    ...
    <div class="grid grid-rows-1 grid-cols-3 items-start gap-4">
        ...
        <div class="w-full flex items-start gap-4 overflow-hidden p-4 border border-gray-300 rounded-lg col-span-3">
            <div class="flex-1 flex flex-col">
