...
@section('content')
    <svg class="w-full ml-auto hidden lg:block" viewBox="0 0 500 500">
        <g>
            <ellipse cx="249.05" cy="350.02" rx="235.61" ry="136.03" style="fill: #f0f0f0"></ellipse>
        </g>
        <g>
            <path
        ...
        <g>
            ...
            <path
                ...
                style="fill: #455a64"></path>
            <polygon points="277.88 224.4 269.33 219.47 268.16 230.01 277.88 224.4" style="fill: #37474f"></polygon>
            <path
        ...
        <g>
            <g>
                ...
                <path
                    ...
                    style="fill: #455a64"></path>
                <rect x="428.77" y="367.54" width="7.27" height="12.96" style="fill: #ffa8a7"></rect>
                ...
                <path d="M416.59,196a1.17,1.17,0,0,0,1.12,1.21,1.22,1.22,0,1,0-1.12-1.21Z" style="fill: #263238"></path>
                ...
                <polygon points="413.25 194.73 413.12 201.84 409.08 200.92 413.25 194.73" style="fill: #f28f8f"></polygon>
                <polyline points="317.31 254.28 323.58 250.66 326.06 247.65 319.8 251.27 317.31 254.28"
                    style="fill: var(--primary)"></polyline>
                <polyline points="317.31 254.28 323.58 250.66 326.06 247.65 319.8 251.27 317.31 254.28"
    ...
    <div class="w-full lg:w-10/12 mx-auto">
        <a href="{{ route('views.login') }}" class="w-full flex justify-center mb-8">
            <img src="{{ asset('logo.png') }}" class="h-[74px] block mx-auto" />
        </a>
        <div class="w-full bg-white p-4 rounded-lg border border-gray-50">
            <form action="{{ route('actions.reset', $token) }}" method="POST" class="w-full flex flex-col gap-4">
                @csrf
                <div class="w-full">
                    <label x-ucfirst for="password" class="block text-sm font-black text-gray-900 mb-1">Password</label>
                    <input x-password id="password" type="password" placeholder="Password" />
                </div>
                <div class="w-full">
                    <label x-ucfirst for="confirm" class="block text-sm font-black text-gray-900 mb-1">Confirm
                        password</label>
                    <input x-password id="confirm" type="password" placeholder="Confirm password" />
                </div>
                <div class="w-full">
                    <button type="button"
