...
@section('content')
    <div class="w-full lg:w-10/12 mx-auto">
        ...
        <div class="w-full bg-white p-4 rounded-lg border border-gray-50">
            <form action="{{ route('views.login') }}" method="POST" class="w-full flex flex-col gap-4">
                @csrf
                <div class="w-full">
                    <p x-ucfirst class="text-gray-900 text-sm">
    ...
    <svg class="w-full ml-auto hidden lg:block" viewBox="0 0 500 500">
        <g>
            <ellipse cx="250" cy="341.91" rx="235.59" ry="136.02" style="fill: #f0f0f0"></ellipse>
        </g>
        <g>
            <ellipse cx="201.25" cy="398.08" rx="81.24" ry="46.9" style="fill: #e0e0e0"></ellipse>
        </g>
        <g>
            <g>
                <path
