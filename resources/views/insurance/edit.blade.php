...
@section('content')
    ...
    <div class="grid grid-rows-1 grid-cols-1 gap-4">
        <div class="w-full bg-white p-4 rounded-lg ">
            <form action="{{ route('actions.insurances.update', $data->id) }}" method="POST"
                ...
                <div class="grid grid-rows-1 grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div class="w-full">
                        <label x-ucfirst for="company" class="block text-sm font-black text-gray-900 mb-1">Company</label>
                        <div class="relative">
                ...
                <div class="w-full">
                    <label x-ucfirst for="fees" class="block text-sm font-black text-gray-900 mb-1">Fees</label>
                    <div class="relative">
                        <input id="fees" type="number" placeholder="Fees" name="fees" value="{{ $data->fees }}"
                            class="appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-md block w-full p-2 focus:outline-1 outline-primary" />
                    </div>
                </div>
                <div class="w-full">
