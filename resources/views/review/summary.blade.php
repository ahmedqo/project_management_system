        ...
        <div class="w-full">
            ...
            <div class="relative">
                <div class="grid grid-rows-1 grid-cols-5">
                    ...
                    <div
                        class="sticky top-0 z-[1] w-full grid grid-rows-1 grid-cols-4 col-span-4 border border-b-0 border-gray-300 bg-primary rounded-t-md">
                        <div class="w-full px-4 py-1 border-r border-gray-300">
                            <span
                                class="block w-full py-2 px-4 text-center text-xs font-black text-white uppercase">poor</span>
                        </div>
                        <div class="w-full px-4 py-1 border-r border-gray-300">
                            <span
                                class="block w-full py-2 px-4 text-center text-xs font-black text-white uppercase">fair</span>
                        </div>
                        <div class="w-full px-4 py-1 border-r border-gray-300">
                            <span
                                class="block w-full py-2 px-4 text-center text-xs font-black text-white uppercase">good</span>
                        </div>
                        <div class="w-full px-4 py-1">
                            <span
                                class="block w-full py-2 px-4 text-center text-xs font-black text-white uppercase">excellent</span>
                        </div>
                    </div>
                    <div class="w-full col-span-5 border border-gray-300 rounded-tr-none rounded-md">
