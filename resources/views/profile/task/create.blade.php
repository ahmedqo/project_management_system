...
@section('content')
    ...
    <div class="grid grid-rows-1 grid-cols-1 gap-4">
        <div class="w-full bg-white p-4 rounded-lg ">
            <form action="{{ route('actions.profile.tasks.store') }}" method="POST" class="w-full flex flex-col gap-4">
                @csrf
                    ...
                    <div class="w-full">
                        ...
                        <div class="relative">
                            <select x-select id="priority" placeholder="Priority" name="priority">
                                <option x-ucfirst value="low">Low</option>
                                <option x-ucfirst value="medium">Medium</option>
                                <option x-ucfirst value="high">High</option>
                                <option x-ucfirst value="critical">Critical</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w-full">
                        ...
                        <div class="relative">
                            <select x-select id="status" placeholder="Status" name="status">
                                <option x-ucfirst value="pending">Pending</option>
                                <option x-ucfirst value="ready">Ready</option>
                                <option x-ucfirst value="progress">Progress</option>
                                <option x-ucfirst value="closed">Closed</option>
                                <option x-ucfirst value="hold">Hold</option>
                            </select>
                        </div>
                    </div>
                </div>
