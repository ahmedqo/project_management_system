...
@section('content')
    <div class="w-full bg-white rounded-lg -mt-12 overflow-hidden">
        <div class="p-4 flex items-center justify-between gap-4">
            ...
            <div class="w-max flex items-center gap-2">
                ...
                <a href="{{ route('views.profile.leaves.create') }}"
    ...
    <div class="flex flex-col gap-4 bg-white rounded-lg p-4">
        <table x-table x-hide="5" x-name="leaves">
            <thead>
                <tr>
                    <td>
                        type
                        ...
                        <td>
                            <div class="w-full h-full flex items-center justify-center gap-2">
                                @if ($row->status == 'pending')
                                    <a href="{{ route('views.profile.leaves.edit', $row->id) }}"
                                    ...
                                    <a href="{{ route('actions.profile.leaves.destroy', $row->id) }}"
...
@section('print')
    <h1 class="text-gray-900 font-black text-2xl text-center mb-16">Leaves List</h1>
